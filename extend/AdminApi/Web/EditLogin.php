<?php
/*
\AdminApi\Web\EditLogin
*/
namespace AdminApi\Web;

class EditLogin extends \AdminApi\Web\Base
{
    public function doProcess()
    {
        ...
        // $dataset['line_channel_id'] = $this->params['line_channel_id']??'';
        // $dataset['line_channel_secret'] = $this->params['line_channel_secret']??'';
